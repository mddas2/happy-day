...
var dialogConfig = {
  ...
  loadScript = function (e, t) {
    ...
    (i.type = "text/javascript"),
      ...
      document.getElementById(htmeditor_textarea1).prepend(i);  //step 1
  },
  load_js_callback = function () {
    Init(htmeditor_textarea, full_screen, editor_height),
    Init(htmeditor_textarea1, full_screen1, editor_height1);  //step 2
  },
  htmeditor_textarea =
  ...
  htmeditor_textarea1 =                                         //step 3
  document.currentScript.getAttribute("htmeditor_textarea1"),
full_screen1 =
  null == document.currentScript.getAttribute("full_screen1")
    ? "no"
    : document.currentScript.getAttribute("full_screen1"),
editor_height1 =
  null == document.currentScript.getAttribute("editor_height1")
    ? "480"
    : document.currentScript.getAttribute("editor_height1"),
run_local1 =
  null == document.currentScript.getAttribute("run_local1")
    ? "no"
    : document.currentScript.getAttribute("run_local1"),
file1 = document.createElement("input1");
...
file.setAttribute("id", "htmeditor-file-input-open-file"),
  ...
  file1.setAttribute("id", "htmeditor-file-input-open-file"),  //step 4
  file1.setAttribute("type", "file"),
  file1.setAttribute("accept", ".html, .html"),
  file.setAttribute("style", "display: none;"),
  document.getElementById(htmeditor_textarea1).prepend(file),
  loadScript(
    "yes" == run_local
      ? "./js/tinymce/tinymce.min.js"
      : "https://htmeditor.com/js/tinymce/tinymce.min.js",
