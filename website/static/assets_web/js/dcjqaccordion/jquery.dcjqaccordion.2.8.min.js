        ...
        $objSub.show(),
          ...
          1 == t.showCount &&
            s("li." + a, u).each(function () {
              if (1 == t.disableLink)
                var a = parseInt(
                  s("ul a:not(." + t.classParent + ")", this).length
                );
              else var a = parseInt(s("ul a", this).length);
              s("> a", this).append(
                ' <span class="' + t.classCount + '">(' + a + ")</span>"
              );
            });
      }
      function l() {
        ($activeLi = s(this).parent("li")),
          ...
          s("> ul", $activeLi).is(":visible")
            ? (s("ul", $activeLi).slideUp(t.speed),
              s("a", $activeLi).removeClass(classActive))
            : (s(this).siblings("ul").slideToggle(t.speed),
