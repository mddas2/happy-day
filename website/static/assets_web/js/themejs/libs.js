        ...
        (e.elem = t),
          ...
          o("#" + e.options.gallery + " a").click(function (i) {
            return (
              ...
              i.preventDefault(),
              (e.zoomImagePre = o(this).data(
                o(this).data("zoom-image") ? "zoom-image" : "image"
              )),
        ...
        e.options.loadingIcon &&
          ((e.spinner = o(
            "<div style=\"background: url('" +
              ...
              "px;width:" +
              e.nzWidth +
              'px;z-index: 2000;position: absolute;top:0; background-position: center center;"></div>'
          )),
